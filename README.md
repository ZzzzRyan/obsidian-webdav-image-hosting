...
1. 下载发布包中的压缩包`webdav-image-hosting.zip`（里面包含 `main.js`、`manifest.json` 和 `styles.css` 文件）
2. 在库文件夹打开或创建 `.obsidian/plugins/webdav-image-hosting/` 目录
3. 将压缩包内文件解压到该目录（不要重叠子文件夹）
